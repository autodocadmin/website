const tryNowButton = document.querySelector('.cta-button');

tryNowButton.addEventListener('click', () => {
    if (isMobileDevice()) {
       
        if (!('BarcodeDetector' in window)) {
            alert('Sorry, your browser doesn\'t support barcode detection. Please try using a modern browser or updating your current one.');
            return;
        }
        ...
        alert("QR code scanner is only accessible on the mobile devices")
    }
});
